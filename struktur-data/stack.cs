...
class AbsensiKelas
{
    ...
    {
        // Create a stack to store the attendance list.
        Stack<string> absensi = new Stack<string>();
        ...
        while (true)
        {
            ...
            switch (pilihan)
            {
                ...
                case 2:
                    // Remove the last added student from the attendance list.
                    if (absensi.Count > 0)
                    {
                        string siswaYangHadir = absensi.Pop();
